...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<Null> _refresh()async{
    var result = await NetworkUtils.getAllProducts();
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
          ...
          child: Container(
            ...
            child: error == null?SingleChildScrollView(
                    child: Column(
                      children: <Widget>[
                        Container(
                            height: 200,
                                    ...
                                    return GestureDetector(
                                      child: Card(
                                        ...
                                        child: CachedNetworkImage(
                                          imageUrl:
                                          '$baseUrl/images/products/${productList[index].id.toString()}/${productList[index].idDefaultImage}/small_default',
                                  ...
                                  itemBuilder: (context, index) {
                                    return GestureDetector(
                                      child: Card(
                                        ...
                                        child: CachedNetworkImage(
                                          imageUrl:
                                          '$baseUrl/images/products/${powerToolList[index].id.toString()}/${powerToolList[index].idDefaultImage}/small_default',
                                          placeholder: (context, url) =>
                                              Image.asset('assets/p.png'),
                                          fit: BoxFit.fitHeight,
                                          width: 130,
                                  ...
                                  itemBuilder: (context, index) {
                                    return GestureDetector(
                                      ...
                                      child: Card(
                                        ...
                                        child: CachedNetworkImage(
                                          imageUrl:
                                          '$baseUrl/images/products/${waterproofList[index].id.toString()}/${waterproofList[index].idDefaultImage}/small_default',
                                          placeholder: (context, url) =>
                                              Image.asset('assets/p.png'),
                                          fit: BoxFit.fitHeight,
                                          width: 130,
                                  ...
                                  itemBuilder: (context, index) {
                                    return GestureDetector(
                                      ...
                                      child: Card(
                                        ...
                                        child: CachedNetworkImage(
                                          imageUrl:
                                          '$baseUrl/images/products/${industrySupplyList[index].id.toString()}/${industrySupplyList[index].idDefaultImage}/small_default',
                                          placeholder: (context, url) =>
                                              Image.asset('assets/p.png'),
                                          fit: BoxFit.fitHeight,
                                          width: 130,
