...
//                                                        _radioValue = value;
//
//                                                      print("address" +addressList[index].id);
//                                                      print("value"+value);
//                                                      print("radio val"+_radioValue);
//                                                       });
//                                                  },
//                                                ),
//                                              ),
...
//                                                        child: Text("+ Add new address",style: TextStyle(fontSize: 16, color: Colors.blueAccent)),
//                                                        onTap: (){
...
//                                    );
                                  return Container(
                                    child: RadioListTile(
                                      ...
                                      onChanged: (value){
                                        setState(() {
                                          setSelectRadioButton(value, addressList[index].id);
                                          selectedAddress = addressList[index].id;
                                        });
                                      },),
                                  );
                                },
                            ...
                            onPressed: () async {
                              ...
                              if (responseJson == null) {
                                ...
                                if(selectedAddress == null){
                                  return NetworkUtils.showSnackBar(_scaffoldKey, "Please select an address");
                                }
                                else{
